...
Value.prototype.get = function() {
  ...
  if(this.type==ValueTypeEnum.REGISTER_OFFSET_MEM) {
    return this.cpu.memory[this.value + this.cpu.registers[this.ref]];
  }
  ...
  if(this.type==ValueTypeEnum.PEEK) {
    return this.cpu.memory[this.cpu.sp];
  }
...
Value.prototype.set = function(val) {
  switch(this.type) {
    ...
    case ValueTypeEnum.REGISTER_OFFSET_MEM:
      this.cpu.memory[this.value + this.cpu.registers[this.ref]] = val;
      break;
    ...
    case ValueTypeEnum.PUSH:
      this.cpu.memory[--this.cpu.sp] = val;
      break;
  }
}
  ...
  if(this.a.done && this.b.done) {
    if(this.skip_next){
      ...
      switch(this.current_opcode) {
        ...
        case 0xc: this.ife(); break;
        case 0xd: this.ifn(); break;
        case 0xe: this.ifg(); break; 
        case 0xf: this.ifb(); break;
      }
    };
