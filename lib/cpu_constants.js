...
stack_operations = {
  POP:{name:'POP',value:0x18},
  PEEK:{name:'PEEK',value:0x19},
  PUSH:{name:'PUSH',value:0x1a},
};

name_for_value = function(array,value) {
  for(var key in array) {
    if(array[key].value == value) {
...
if(typeof(exports) != 'undefined') {
  ...
  exports.special_registers = special_registers;
